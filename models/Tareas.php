...
class Tareas extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['titulo', 'detalles', 'usuario','categoria','prioridad','estima_duracion','fecha_inicio','fecha_limite'], 'required', 'message' => 'Por favor, introduzca {attribute}'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'detalles' => 'Detalles',
            'prioridad' => 'Prioridad',
            'estima_duracion' => 'Estima Duracion (en horas)',
